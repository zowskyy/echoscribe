...
class HistoryPage extends StatelessWidget {
  ...
  Future<void> _resetShareDuplicateGuard() async {
    settings.setLastSharedIntentId('');
    await secureStorage.saveLastSharedIntentId('');
  }
                    ...
                    : () async {
                        final ok = await showDialog<bool>(
                          ...
                          builder: (context) => AlertDialog(
                            ...
                            content: const Text(
                                'This will remove all transcriptions.'),
                            actions: [
                              TextButton(
                                  onPressed: () =>
                        ...
                        if (ok == true) {
                          ...
                          await _resetShareDuplicateGuard();
                          if (!context.mounted) return;
            ...
            child: items.isEmpty
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, i) => _HistoryTile(
                      item: items[i],
                      onDelete: () {
                        content.deleteHistoryItem(items[i].id);
...
class _HistoryTile extends StatelessWidget {
  ...
  const _HistoryTile(
      {required this.item, required this.onDelete, required this.onSelect});
    ...
    return Dismissible(
      ...
      background: Container(
        decoration: BoxDecoration(
            color: c.errorContainer, borderRadius: BorderRadius.circular(14)),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          onTap: onSelect,
          onLongPress: () =>
              SharePlus.instance.share(ShareParams(text: item.text)),
          child: Padding(
            ...
            child:
              ...
              Row(children: [
                ...
                if (item.duration != null) ...[
                  ...
                  const SizedBox(width: 6),
                  Text('${item.duration!.inSeconds}s',
                      style: Theme.of(context).textTheme.labelMedium),
