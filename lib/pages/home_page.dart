...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _initShareHandling() async {
    ...
    _shareIntentController = ShareIntentController(
      ...
      onAudioReceived: (path, name, mime) async {
        return await _controller.processSharedAudio(
            path: path, filename: name, mimeType: mime, mode: "transcription");
      },
        ...
        builder: (context) {
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final isSelected = _settings.targetLanguageCode == lang['code']!;
              return ListTile(
                ...
                onTap: () async {
                  ...
                  navigator.pop();
                  if (oldLang != value &&
                      _content.sourceTranscriptValue.isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
        listenable: Listenable.merge([_settings, _content, _playback]),
        builder: (context, _) {
          return Scaffold(
              ...
              child: OrientationBuilder(
                builder: (context, orientation) {
                  ...
                  final transcriptionPanel = TranscriptionPanel(
                    ...
                    onGenerateImage: () =>
                        _controller.generateImageFromCurrentContent(
                      ...
                      LayoutBuilder(
                        builder: (context, constraints) {
                          ...
                          final isTranscription =
                              _content.outputMode == OutputMode.transcription;
                          return ToggleButtons(
                            ...
                            onPressed: (index) async {
                              if (index == 0) {
                                ...
                                if (_content.currentSummaryValue.isEmpty &&
                                    _content
                                        .currentTranscriptValue.isNotEmpty &&
                                    !_content.isTranscribing) {
                                  await _controller
                            ...
                            constraints: BoxConstraints(
                                minHeight: 44, minWidth: minWidth),
                                ...
                                children: [
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    StopButton(
                                                      ...
                                                      onPressed: () async {
                                                        if (!_settings.provider
                                                            .supportsTts) {
                                                          _showError(
                                                              "${_settings.provider.brandName} does not support audio playback");
                                                          return;
                                                        }
                                                        try {
                                                          _hideProgressToast();
                                  ...
                                  AnimatedBuilder(
                                    animation: Listenable.merge([
                                      _controller.levelNotifier,
                                      _controller.smoothedLevelNotifier
                                    ]),
                                    builder: (context, child) {
                                      final pulse = _content.isRecording
                                          ? _controller
                                              .smoothedLevelNotifier.value
                                              .clamp(0.0, 1.0)
                                          : 0.0;
                                      final flicker = _content.isRecording
                                          ? _controller.levelNotifier.value
                                              .clamp(0.0, 1.0)
                                          : 0.0;
                                      final ringColors = _content.isRecording
                                          ? [
                                              color.error.withValues(
                                                  alpha: 0.16 + 0.18 * pulse),
                                              color.error.withValues(
                                                  alpha: 0.03 + 0.03 * pulse),
                                            ]
                                          : [
                                              color.secondary
                                    ...
                                    child: Center(
                                      child: AnimatedSwitcher(
                                        ...
                                        child: showImage
                                            ? ImageGenButton(
                                                isLoading:
                                                    _content.isGeneratingImage,
                                                enabled:
                                                    _settings.hasActiveApiKey,
                                                supportsImage: _settings
                                                    .provider.supportsImage,
                                                onPressed: () async {
                                                  if (!_settings
                                                      .provider.supportsImage) {
                                                    _showError(
                                                        "${_settings.provider.brandName} does not support image generation");
                                                    return;
                                                  }
                                                  await _controller
                                                      .generateImageFromCurrentContent(
                                                    showProgressToast:
                                                        _showProgressToast,
                                                    hideProgressToast:
                                                        _hideProgressToast,
                        ...
                        child: AnimatedSwitcher(
                          ...
                          child: _content.isRecording
                              ...
                              : !_settings.provider.supportsAudio
                                  ? Text(
                                      "${_settings.provider.brandName} has no audio support",
